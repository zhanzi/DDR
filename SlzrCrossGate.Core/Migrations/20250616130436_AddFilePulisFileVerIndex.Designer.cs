...
namespace SlzrCrossGate.Core.Migrations
{
    ...
    [Migration("20250616130436_AddFilePulisFileVerIndex")]
    partial class AddFilePulisFileVerIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SlzrCrossGate.Core.Models.FilePublish", b =>
                {
                    ...
                    b.HasIndex("PublishTime")
                        .IsDescending()
                        .HasAnnotation("SqlServer:Include", new[] { "MerchantID", "FileTypeID", "Ver", "FilePara", "FileFullType", "PublishTarget" });
            ...
            modelBuilder.Entity("SlzrCrossGate.Core.Models.FileVer", b =>
                {
                    ...
                    b.HasIndex("CreateTime")
                        .IsDescending()
                        .HasAnnotation("SqlServer:Include", new[] { "MerchantID", "FileTypeID", "Ver", "FilePara", "FileFullType" });
            ...
            modelBuilder.Entity("SlzrCrossGate.Core.Models.MsgBox", b =>
                {
                    ...
                    b.HasIndex("SendTime")
                        .IsDescending()
                        .HasAnnotation("SqlServer:Include", new[] { "MerchantID", "Status", "TerminalID", "MsgContentID" });
            ...
            modelBuilder.Entity("SlzrCrossGate.Core.Models.TerminalEvent", b =>
                {
                    ...
                    b.HasIndex("EventTime")
                        .IsDescending()
                        .HasAnnotation("SqlServer:Include", new[] { "MerchantID", "TerminalID", "EventType" });

                    b.HasIndex("TerminalID", "EventTime")
                        .IsDescending(false, true)
                        .HasAnnotation("SqlServer:Include", new[] { "MerchantID", "EventType" });
