...
namespace SlzrCrossGate.Core.Migrations
{
    ...
    [Migration("20250430074051_updatefilepublish2")]
    partial class updatefilepublish2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SlzrCrossGate.Core.Models.ConsumeData", b =>
                {
                    ...
                    b.HasIndex("ReceiveTime")
                        .HasAnnotation("SqlServer:Include", new[] { "MerchantID", "MachineID" });
            ...
            modelBuilder.Entity("SlzrCrossGate.Core.Models.TerminalEvent", b =>
                {
                    ...
                    b.HasIndex("MerchantID", "TerminalID", "EventType");
